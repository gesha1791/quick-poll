...
public class QuickPollClient {
    private static final String QUICK_POLL_URI_V1 = "http://localhost:8090/v1/polls";
    ...
    public static void main(String[] args) {
        ...
        // Test Update Poll with Id 1006
        Poll pollForId6 = client.getPollById(1006L);
        // Add a new Option
